            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                     ...
                     <li class="dropdown dropdown-notification nav-item">
                         <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon bx bx-plus"></i></a> 
                         <ul class="dropdown-menu dropdown-menu-right"> 
                             <li class="scrollable-container media-list"><a class="d-flex justify-content-between" href="javascript:void(0)"> 
                                ...
                                <a class="dropdown-item" href="/roles"><i class="bx bx-plus mr-1"></i> Partner</a>
                                <a class="dropdown-item" href="/roles"><i class="bx bx-plus mr-1"></i> Customer</a>
                                <a class="dropdown-item" href="/roles"><i class="bx bx-plus mr-1"></i> Transaction</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none">
                                ...
                                <span class="user-status text-muted">{{empty(auth::user()->role) ? '-' : auth::user()->role->name}}</span>
                            </div>
                            <span><img class="round" src="/app-assets/upload/{{auth::user()->role->name}}.png" alt="avatar" height="40" width="40"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right pb-0"><a class="dropdown-item" href="page-user-profile.html"><i class="bx bx-user mr-50"></i> Edit Profile</a><a class="dropdown-item" href="app-email.html"><i class="bx bx-envelope mr-50"></i> My Inbox</a><a class="dropdown-item" href="app-todo.html"><i class="bx bx-check-square mr-50"></i> Task</a><a class="dropdown-item" href="app-chat.html"><i class="bx bx-message mr-50"></i> Chats</a>
                                <div class="dropdown-divider mb-0"></div><a class="dropdown-item" href="/logout"><i class="bx bx-power-off mr-50"></i> Logout</a>
                            </div>
                    </li>
                </ul>
            </div>
